...
class FullFlowIntegrationTest {
        ...
        class WorkspaceFlowTests {
                ...
                void updateWorkspace() throws Exception {
                        ...
                        mockMvc.perform(put("/v1/workspaces/" + wsId)
                                        .header("Authorization", "Bearer " + token)
                                        .contentType(MediaType.APPLICATION_JSON)
                                        .content("""
                ...
                void deleteWorkspace() throws Exception {
                        ...
                        mockMvc.perform(delete("/v1/workspaces/" + wsId)
                                        .header("Authorization", "Bearer " + token))
                                        .andExpect(status().isOk())
        ...
        class MemberFlowTests {
                ...
                void addAndRemoveMember() throws Exception {
                        mockMvc.perform(post("/v1/workspaces/" + workspaceId + "/member/add")
                        ...
                        mockMvc.perform(get("/v1/workspaces/" + workspaceId + "/member/count")
                                        .header("Authorization", "Bearer " + ownerToken))
                                        .andExpect(status().isOk())
                                        .andExpect(content().string("2"));

                        mockMvc.perform(delete("/v1/workspaces/" + workspaceId + "/member/remove")
                                        .header("Authorization", "Bearer " + ownerToken)
                ...
                void changeMemberRole() throws Exception {
                        ...
                        mockMvc.perform(post("/v1/workspaces/" + workspaceId + "/member/change-role")
                                        .header("Authorization", "Bearer " + ownerToken)
                                        .contentType(MediaType.APPLICATION_JSON)
                                        .content("""
                ...
                void memberLeaves() throws Exception {
                        ...
                        mockMvc.perform(post("/v1/workspaces/" + workspaceId + "/member/leave")
        ...
        class SecurityTests {
                ...
                void memberAccess_vs_nonMemberDenied() throws Exception {
                        ...
                        mockMvc.perform(post("/v1/workspaces/" + wsId + "/member/add")
                                        .header("Authorization", "Bearer " + ownerToken)
                                        .contentType(MediaType.APPLICATION_JSON)
                                        .content("""
                                                        {"email": "member@test.com", "role": "MEMBER"}
        ...
        class DocumentTrashFlowTests {
                ...
                void softDeleteAndRestore() throws Exception {
                        ...
                        mockMvc.perform(post("/v1/documents/" + docId + "/delete")
                                        .header("Authorization", "Bearer " + token))
                                        .andExpect(status().isOk())
                        ...
                        mockMvc.perform(post("/v1/documents/" + docId + "/restore-deleted")
                                        .header("Authorization", "Bearer " + token))
                                        .andExpect(status().isOk())
                                        .andExpect(content().string("Document restored successfully"));
