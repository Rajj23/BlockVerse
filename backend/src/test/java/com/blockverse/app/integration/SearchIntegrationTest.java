...
class SearchIntegrationTest {
    ...
    void search_integration_success() throws Exception {
        ...
        BlockResponse block = BlockResponse.builder()
                ...
                .content("UniqueBlockKeyword content here.")
                .position(BigInteger.ONE)
                .build();
        ...
        when(searchService.search("UniqueTitleKeyword", workspaceId)).thenReturn(response1);
        when(searchService.search("UniqueBlockKeyword", workspaceId)).thenReturn(response2);
